...
public class IPv4Analyzer extends PacketAnalyzerAbstract
{
	...
	public void analyze(Packet packet){
		...
		values.put(valueNames[0],Integer.valueOf(4));
		values.put(valueNames[1],Integer.valueOf(ip.priority));
		values.put(valueNames[2],Boolean.valueOf(ip.t_flag));
		values.put(valueNames[3],Boolean.valueOf(ip.r_flag));
		values.put(valueNames[4],Integer.valueOf(ip.length));
		values.put(valueNames[5],Integer.valueOf(ip.ident));
		values.put(valueNames[6],Boolean.valueOf(ip.dont_frag));
		values.put(valueNames[7],Boolean.valueOf(ip.more_frag));
		values.put(valueNames[8],Integer.valueOf(ip.offset));
		values.put(valueNames[9],Integer.valueOf(ip.hop_limit));
		values.put(valueNames[10],Integer.valueOf(ip.protocol));
